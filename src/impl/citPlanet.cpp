...
CitPlanet::CitPlanet(string name) : Planet(name, Direction::F, "the spaceship, lying as you first found it.")
{
    ...
    houses = new Item(true, false, "Rows of houses spilling their guts on to the road surround you.", "The houses look like they have been destroyed by a large explosion. You wonder who lived there, and how they must have died.");
    ...
    cit = new Item(true, false, "There is a large building that looks like it might be a citadel of some sort.", "The imposing building looks like it would be difficult to attack and easy to defend. You wouldn't mind living inside it during a seige.");
    ...
    ship_item = new Item(true, false, "A spaceship rests lopsidedly in the dirt.", "The spaceship looks in a much worse state than it actually is. You hope.");
